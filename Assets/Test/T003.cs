...
// This class is not demonstrated in the Main method -- 没有被真的调用和使用
// and is provided only to show how to implement the interface. 
